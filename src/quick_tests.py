"""
Quick little tests to check different parts of the code as a scratchpad. To be deleted later.
"""
...
from src.sample_user_input import sample_input, sample_input2
